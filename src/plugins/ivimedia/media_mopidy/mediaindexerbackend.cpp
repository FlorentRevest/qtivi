...
MediaIndexerBackend::MediaIndexerBackend(QSharedPointer<mopidy::JsonRpcHandler> jrhdl, QObject *parent)
...
{
    m_libraryCtrl.refresh();
//    m_state = QIviMediaIndexerControl::Active;
//    emit stateChanged(m_state);
// TODO: When is a scan finished ?
}
