...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID QIviServiceInterface_iid FILE "media_mopidy.json")
...
private slots:
    ...
    void onClientConnectionError(int code, const QString &message);
    void onJsonRpcError(mopidy::JsonRpcHandler::RpcErrorCode ec, const QJsonObject &jsonRpcErrorObj);
